    ...
    <header className="bg-gray-800 text-white py-4">
      ...
      {menuOpen && (
        <nav className="lg:hidden bg-gray-800 px-4 py-2">
          <Link href="/" className="block py-2 text-gray-300 hover:bg-gray-700 rounded">
            Home
          </Link>
          <Link href="/home" className="block py-2 text-gray-300 hover:bg-gray-700 rounded">
            Products
          </Link>
          <Link href="/about" className="block py-2 text-gray-300 hover:bg-gray-700 rounded">
            About
          </Link>
          <div className="relative">
          <div className="hover:text-gray-400 mr-6">
